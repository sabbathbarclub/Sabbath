        ...
        <div className="bg-[#050505] min-h-screen text-white overflow-hidden">
            ...
            <section className="relative h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto animate-fade-in">
                    ...
                    <img src="https://lh3.googleusercontent.com/d/1px0FfwDm0GEmH8qI-RzU8_4jZM3q9UQo" alt="SÀBBATH" className="w-80 md:w-[550px] object-contain mx-auto mb-6 filter brightness-110 drop-shadow-[0_0_40px_rgba(168,85,247,0.8)]" />
